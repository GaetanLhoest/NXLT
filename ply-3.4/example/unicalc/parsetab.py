...
_lr_productions = [
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','calc.py',76),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','calc.py',77),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','calc.py',78),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','calc.py',79),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','calc.py',86),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','calc.py',90),
  ('expression -> NUMBER','expression',1,'p_expression_number','calc.py',94),
  ('expression -> NAME','expression',1,'p_expression_name','calc.py',98),
]
