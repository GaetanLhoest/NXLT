...
def p_function_definition(p):
	'''function_definition :  head NEWLINE LBRACE NEWLINE body RBRACE NEWLINE
						   ...
						   |  IDENTIFIER SHARP head NEWLINE LBRACE NEWLINE body RBRACE NEWLINE
						   |  IDENTIFIER SHARP head LBRACE NEWLINE body RBRACE NEWLINE'''
...
def p_array_declaration(p):
	'''array_declaration	: IDENTIFIER bracket_list'''
	p[0] = p[2]
		
def p_array_assignment(p):
	'''array_assignment	: IDENTIFIER bracket_list EQUALS value_list'''
	p[0] = p[4]
	
def p_bracket_list(p):
	'''bracket_list	: LBRACKET NUMBER RBRACKET
					| LBRACKET IDENTIFIER RBRACKET
					| bracket_list LBRACKET IDENTIFIER RBRACKET
					| bracket_list LBRACKET NUMBER RBRACKET'''
	if len(p) == 4:
		p[0] = p[2]
	elif len(p) == 5:
