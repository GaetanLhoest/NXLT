...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','calc.py',58),
  ('statement -> expression','statement',1,'p_statement_expr','calc.py',62),
  ...
  ('expression -> - expression','expression',2,'p_expression_uminus','calc.py',76),
  ('expression -> ( expression )','expression',3,'p_expression_group','calc.py',80),
  ('expression -> NUMBER','expression',1,'p_expression_number','calc.py',84),
  ('expression -> NAME','expression',1,'p_expression_name','calc.py',88),
]
